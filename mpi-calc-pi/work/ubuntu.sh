...
partition=mit_normal_gpu  # ou_sloan_gpu  # mit_normal #mit_normal_gpu #pi_mghassem  # mit_normal  # CHANGE_ME: what partition are we using
reservation=orcd_testing  # "" #WareWulf_testing  # orcd_testing
cpu_count=176  #96  #48  # 88  # 32  # 96  # 40  # 192             # CHANGE_ME: how many physical cores are on the node.
