...
nodes=(1804 1805)                                                              # CHANGE ME: what nodes will we run the job on?
partition=pi_cdrennan_gpu                                                     # CHANGE_ME: what partition are we using
cpu_count=48                                                              # CHANGE_ME: how many physical cores are on the node. We will request all of them
