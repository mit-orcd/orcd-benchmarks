...
exe32p=("MatMult" "MatMult_16x16" "MatMult_16x32" "matmul_cuBLAS") # list executables for single precision programs you want to run
exe64p=("MatMult_d_h100" "MatMult_d_h100_16x16" "MatMult_d_h100_16x32" "matmul_cuBLAS_d_h100") # list executables for double precision programs you want to run
