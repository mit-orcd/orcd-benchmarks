...
$sing_cmd /workspace/hpl-mxp.sh --n 380000 --nb 2048 --gpu-affinity 0
...
echo "======================= 2 GPUs ========================="
  ...
  $sing_cmd mpirun -np 2 /workspace/hpl-mxp.sh --n 380000 --nb 2048 --nprow 1 --npcol 2 --nporder row --gpu-affinity 0:1
fi
...
if [ $gpu_count -ge 4 ]; then
  ...
  $sing_cmd mpirun -np 4 /workspace/hpl-mxp.sh --n 380000 --nb 2048 --nprow 2 --npcol 2 --nporder row --gpu-affinity 0:1:2:3
fi
...
if [ $gpu_count -ge 8 ]; then
  ...
  $sing_cmd mpirun -np 8 /workspace/hpl-mxp.sh --n 380000 --nb 2048 --nprow 2 --npcol 4 --nporder row --gpu-affinity 0:1:2:3:4:5:6:7
fi

echo "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Run hpcg %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
$sing_cmd /workspace/hpcg.sh --nx 256 --ny 256 --nz 256 --rt 120
...
do
  $sing_cmd /workspace/stream-gpu-linux-x86_64/stream-gpu-test.sh -n 430080000 -d $gpu_id 
done
