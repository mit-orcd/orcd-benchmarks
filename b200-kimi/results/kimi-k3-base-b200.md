...
![Two server computers drawn as rack boxes. Each box holds two GPUs, each GPU with its own memory, joined inside the box by a direct link. A network cable runs between the two boxes.](kimi-k3-two-nodes-plain.svg)

*The same idea without the jargon, for readers new to HPC: each box is one computer (a node), the cards inside it are GPUs, each GPU has its own memory, and a network cable joins the two boxes so they can work on one model together. Simplified — the real job uses eight GPUs per node, not the two drawn here.*
...
### 7.3 Aggregate throughput — theirs vs ours

Their API carries aggregate output throughput (`output_tput_tps`) at every concurrency point — the same quantity as our §1 "Throughput (tok/s)" column. Their **B200 arms are 16 GPUs, TP8 × PP2 across 2 nodes — the same layout as ours**; their MI355X arms are 8 GPUs on one node.
...
|---:|---:|---:|---:|---:|---:|---:|
| 1 | 86.7 | 59.9 | 118.1 | 67.4 | 91.0 | 46.1 |
| 2 | 165.2 | 72.1 | 144.5 | — | — | 87.0 |
| 4 | 280.8 | 76.0 | 190.3 | 115.7 | 137.1 | 154.2 |
| 8 | 475.3 | 99.7 | 338.3 | 169.5 | 233.0 | 288.0 |
| 10 | — | — | — | 235.0 | 293.1 | — |
| 16 | 801.8 | 92.4 | 518.0 | — | — | 500.9 |
| 32 | 1,209.3 | 60.2 | 768.0 | — | — | 824.0 |
| 48 | — | 838.2 | — | — | — | — |
| 64 | 1,696.4 | — | — | — | — | 1,258.5 |
| 72 | — | 1,021.6 | — | — | — | — |
| 96 | — | 1,159.4 | — | — | — | — |
