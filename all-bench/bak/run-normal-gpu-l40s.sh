# for all nodes
nodes="1634"  # "4508"  #"3617" # "4300 4301"
partition=mit_normal_gpu   # pi_mshoulde # pi_qmqi # pi_mshoulde pg_tata #ou_sloan_gpu  # mit_normal # mit_normal_gpu
reservation="orcd_testing" #orcd_testing # ""  #orcd_testing  #  WareWulf_testing
qos=unlimited
cpus=48  # 96  # 48  # 40  #96  # 40  # 88  # all cores on a CPU  node, substract reserved cores on a GPU node
