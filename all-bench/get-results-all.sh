partition=ou_bcs_low  # pi_zhang_f # pi_keating  #pg_tata # pi_mshoulde #  pi_qmqi # pg_tata #ou_sloan_gpu  # mit_normal # mit_normal_gpu
lines=2 # 7 #3 #2  # how many jobs you want to get results from + 1
