partition=mit_normal_gpu  # mit_normal_gpu
lines=7 #2  #10 # 7 #3 #2  # how many jobs you want to get results from + 1
...
#all_bench="nvidia-hpc-benchmarks nccl-tests"   # H200 GPU nodes
