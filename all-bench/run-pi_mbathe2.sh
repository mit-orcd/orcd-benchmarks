# for all nodes
nodes="4213" #"3009 3209" 
partition=mit_testing   # pi_mshoulde # pi_qmqi # pi_mshoulde pg_tata #ou_sloan_gpu  # mit_normal # mit_normal_gpu
reservation=none  #orcd_testing  # none #none #orcd_testing  #  WareWulf_testing
qos=normal  #unlimited  # normal   # unlimited
cpus=32  # 48  # 40  #96  # 40  # 88  # all cores on a CPU  node, substract reserved cores on a GPU node
...
all_bench="gpu-burn-r8 openmp mpi-calc-pi"   #  H100 GPU nodes
