...
all_bench="nvidia-hpc-benchmarks gpu-burn-r8"   # H200 GPU nodes
#all_bench="nccl-tests gpu-burn-r8 nvidia-hpc-benchmarks openmp mpi-calc-pi"   # H200 GPU nodes
#all_bench="nccl-tests nvidia-hpc-benchmarks gpu-burn-r8 mpi-p2p openmp"   # H200 GPU nodes
#all_bench="nccl-tests nvidia-hpc-benchmarks gpu-burn-r8"   # H200 GPU nodes
