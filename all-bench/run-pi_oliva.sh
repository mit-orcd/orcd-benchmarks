# for all nodes
nodes="4109 3409" #"3009 3209" 
partition=pi_oliva   # pi_mshoulde # pi_qmqi # pi_mshoulde pg_tata #ou_sloan_gpu  # mit_normal # mit_normal_gpu
...
# only for GPU nodes
gpu_type=h100 # l40s  # a100 #h100 # h200 # l40s
gpus=8  #2  #8  #4
