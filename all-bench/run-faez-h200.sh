...
cpus=88  #64  # 48  # 40  #96  # 40  # 88  # all cores on a CPU  node, substract reserved cores on a GPU node
...
all_bench="gpu-burn-r8 nccl-tests openmp mpi-calc-pi"   # H200 GPU nodes
