...
#SBATCH -t 30
#SBATCH -N 2
#SBATCH --ntasks-per-node=2  # 4
#SBATCH --gpus-per-node=2    # 4

#SBATCH -J nvhpc-23.3-ompi3 
#SBATCH -w node[2802,2803]     # node[1802,1803]  node[2802,2803]  node[1702,1703]  node[2702,2703]
...
MAX_SIZE=16G
FACTOR=4
GPUS_PER_TASK=1 # $SLURM_GPUS_PER_NODE
